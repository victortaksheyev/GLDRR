...
// thresholds
#define LIFTOFF_ALTITUDE_THRESHOLD (10.0f) // m
#define LIFTOFF_DELTA_THRESHOLD (0.3f)    // m
#define LAUNCH_ACCEL_THRESHOLD (3.0f)     // gs

#define ALTIMERER_APOGEE_DETECTION_MEASURES (10)
#define ALTIMERER_LANDING_DETECTION_MEASURES (10)
#define ALTIMETER_LIFTOFF_DETECTION_MEASURES (5)
#define IMU_LIFTOFF_DETECTION_MEASURES (5)
